...
apptainer exec --nv --cleanenv \
  ...
  bash -lc 'set -Eeuo pipefail; source /opt/conda/etc/profile.d/conda.sh; conda activate dexbotic; export PYTHONPATH=/mnt/dexbotic:'"${SUPPORT_ROOT}"':${PYTHONPATH:-}; cd /mnt/dexbotic; python -u /share/data/ripl/tianchong/projects/Eval_Policies_CoRL/scratch/repeated_fixed_grid_calibration_288_20260523_v2/dexbotic_support/bin/launch_memvla_server_seeded.py' \
